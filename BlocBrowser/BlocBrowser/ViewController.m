...
- (void)loadView {
    ...
    self.textField.placeholder = NSLocalizedString(@"Website URL or Type in your search word", @"Placeholder text for web browser URL field");
    ...
    // essentially same thing as below code
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    if ([URLString containsString:@" "]) {
        ...
        URLString = [NSString stringWithFormat:@"http://www.google.com/search?q=%@", escapedString];
    }
